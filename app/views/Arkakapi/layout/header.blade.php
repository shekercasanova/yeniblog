    ...
    <div class="navbar-inner">
        <div class="container">
            <div class="brand-wrap pull-left">
                <div class="brand-img">
                    <a class="brand" href="{{Config::get('app.url')}}/arkakapi">
                        <img src="{{asset('assets/images/logo.png')}}" alt="" style="width: 117px; height: 21px;">
                    </a>
                </div>
            </div>
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item-wrap">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <span class="thumbnail"><img src="{{URL::to('assets/images/pp.jpg')}}" alt=""></span>
                                            <span class="details">
                    ...
                    <div id="user-info" class="clearfix">
                        ...
                        <div class="avatar">
                            <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                                <img src="{{URL::to('assets/images/pp.jpg')}}" alt="Avatar">
                            </a>
                            <ul class="dropdown-menu pull-right">
                                <li><a href="profile.html"><i class="icol-user"></i> My Profile</a></li>
                                <li><a href="#"><i class="icol-layout"></i> My Invoices</a></li>                                        
                                <li class="divider"></li>
                                <li><a href="{{Config::get('app.url')}}/logout"><i class="icol-key"></i> Logout</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="logout-ribbon">
                        <a href="{{Config::get('app.url')}}/logout"><i class="icon-off"></i></a>
                    </div>
                </div>
            </div>
        </div>
